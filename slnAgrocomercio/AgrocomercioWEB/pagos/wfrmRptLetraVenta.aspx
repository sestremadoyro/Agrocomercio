<%@ Page Title=".:Registro de Letras:." Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="wfrmRptLetraVenta.aspx.cs" Inherits="AgrocomercioWEB.pagos.wfrmRptLetraVenta" %>
                ...
                <tr>
                    <td colspan="2">
                        <h2 class="clsTituloInterior">
                            SISTEMA DE PAGOS DE LAS VENTAS DE AGROCOMERCIO S.R.L.</h2>
                                                                                    ...
                                                                                    <asp:GridView ID="dgvFacPend" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                                        ...
                                                                                        <Columns>
                                                                                          ...
                                                                                          <asp:BoundField DataField="PrvRazon" HeaderText="Cliente" SortExpression="PrvRazon" />
                                                                                            ...
                                                                                            <%--  10--%>  
                                                                                            <asp:BoundField DataField="percod" HeaderText="Tracod" SortExpression="percod" />
                                                                                            <asp:BoundField DataField="tranom" HeaderText="Vendedor" SortExpression="percod" />
                                                                                ...
                                                                                <td colspan="3">
                                                                                    <asp:GridView ID="dgvLetReg" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField DataField="ctippago" HeaderText="ctippago" ReadOnly="True" SortExpression="ctippago" />
                                                                                            <asp:BoundField DataField="PerCod" HeaderText="Tracod" ReadOnly="True" SortExpression="PerCod" />
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <asp:RadioButton ID="rbtletra" Text="por # de Letras" GroupName="GRUPO1" OnCheckedChanged="rbtdias_CheckedChanged"
                                                                                        Checked="true" runat="server" AutoPostBack="true" Font-Size="Medium" />
                                                                                    <asp:RadioButton ID="rbtdias" Text="# de dias" GroupName="GRUPO1" OnCheckedChanged="rbtdias_CheckedChanged"
                                                                                        runat="server" AutoPostBack="true" Font-Size="Medium" />
                                                                                </td>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblTipPag" runat="server" Text="Numero de Cuotas:" Font-Bold="True"
