                                                        ...
                                                        <table class="Nuevo">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtmontoPagado" runat="server" Width="80px" OnTextChanged="txtmontos_TextChange"
                                                        AutoPostBack="true" BorderColor="Red" BorderStyle="Dashed" Font-Bold="True" Font-Size="Medium"></asp:TextBox></td>
                                                            <td>(*)</td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right" class="style4" style="font-weight: bold">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <asp:TextBox ID="txtFecPag" runat="server" Width="80px" Height="23px"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2" style="margin-left: 80px">
                                                                    <asp:TextBox ID="txtinter" runat="server" Width="80px" OnTextChanged="txtinter_TextChange"  AutoPostBack="true"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            <td  align="right">
                                                            ...
                                                            <tr>
                                                                <td colspan=3>
                                                                    <asp:Label ID="lblmsg" runat="server" 
                                                                        Text="*Es necesario ingresar un monto mayor o igual al monto a pagar" 
