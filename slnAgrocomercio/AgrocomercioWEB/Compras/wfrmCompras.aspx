...
<table class="MainContent" >
    <tr>
        <td colspan="2"> 
            <h1 class="clsTituloPrincipal2">COMPRAS DE AGROCOMERCIO S.R.L.</h1>
                ...
                <tr>
                    ...
                    <asp:panel id="pnListOperCompras" runat="server">
                        ...
                        <tr>
                            <td class="clsCellTituloDatos2" >
                               <asp:CheckBox ID="chkPorProveedor" runat="server" Text="Por Proveedor:  " 
                                    AutoPostBack="True" oncheckedchanged="chkPorProveedor_CheckedChanged"  /> 
                            </td>
                            <td class="clsCellDatos2" colspan="3" >
                                <asp:DropDownList ID="ddlProveedorFiltro" runat="server" Width="220px" 
                                    DataTextField="PrvRazon" DataValueField="PrvCod" AutoPostBack="True" onselectedindexchanged="ddlProveedoresFiltro_SelectedIndexChanged" 
                                    >
                                </asp:DropDownList>
                            </td>
                        </tr>
                    ...
                    <td class="tabDerecha" valign="top">
                        <div class="divDerecha">
                                ...
                                <tr>
                                    <td class="clsCellTituloSmall"  style=" width:100px">PRECIO DE COMPRA: </td>
                                    <td style=" width:80px"><asp:Label ID="txtPrecioCompra" runat="server" Text="Label"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="clsCellTituloSmall">DESCUENTO ESP (-): </td>
                                ...
                                <tr>
                                    <td class="clsCellTituloSmall">COSTO DE COMPRA: </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="clsCellDatosLarge2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="txtCostoTotal" runat="server" Text="S/. 0.00"></asp:Label></td>
                                </tr>
                                </table>
                                </asp:Panel>
                                </div>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table style=" width:220px; height:100%;" id="TablaArtLeft" runat="server">
                                                ...
                                                <tr>
                                                    <td class="clsCellTituloDatos2" valign="top" >
                                                        <asp:Label ID="lblTitArticulos" runat="server" Text="Articulos:"></asp:Label> </td>
                                                    <td class="clsCellDatos2"  valign="top" > 
                                                        ...
                                                        <div id="listPlacement" class="cls_listPlacement" runat="server"></div>
                                            ...
                                            <table style=" width:220px; height:100%;">
                                                ...
                                                <tr>
                                                    <td class="clsCellTituloDatos2" valign="top" style=" font-weight:bold; color:#444444;">
                                                        Cantidad : &nbsp;</td>
                                                    <td class="clsCellDatos2"  valign="top" >
                                                        <asp:TextBox ID="txtArtCant" runat="server"  Width="100px" 
                                                             ClientIDMode="Static"  onkeyup="CalcularTotalArticulo('TOTAL');" ></asp:TextBox>
	                            ...
	                            <asp:panel id="pnDatosAdicionales" runat="server" >
                                    <table style=" width:450px; height:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="clsCellDatos2" ><asp:TextBox ID="txtDesEspec" runat="server" 
                                                    Width="120px" AutoPostBack="True" ontextchanged="txtDesEspec_TextChanged"></asp:TextBox></td>
                                            <td class="clsCellTituloDatos2" >Flete de Trans: </td>
                                            <td class="clsCellDatos2" >
                                                <asp:TextBox ID="txtFleteTra" runat="server" 
                                                    Width="100px" AutoPostBack="True" 
                                                    ontextchanged="txtFleteTra_TextChanged" ></asp:TextBox></td>                    
                                        </tr>
                                        <tr>
