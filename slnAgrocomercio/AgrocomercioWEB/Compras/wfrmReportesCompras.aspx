<%@ Page Title=".:Reportes de Compras:." Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="wfrmReportesCompras.aspx.cs" Inherits="AgrocomercioWEB.Compras.wfrmReportesCompras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AbrirVentanaProveedoresMes() {
            window.open('Reportes/wfrmVistaRepProveedoresMes.aspx', '_blank', 'width=990px,height=600px,scrollbars=si,menubar=no,resizable=no,left=200px, top=70px');
        }
        function AbrirVentanaProveedoresGeneral() {
            window.open('Reportes/wfrmVistaRepProveedoresGeneral.aspx', '_blank', 'width=990px,height=600px,scrollbars=si,menubar=no,resizable=no,left=200px, top=70px');
        }
    ...
    <asp:UpdateProgress ID="updateProgress" runat="server" AssociatedUpdatePanelID="MainUpdatePanel"
        ...
        <ProgressTemplate>
            <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0;
                right: 0; left: 0; z-index: 8888888; background-color: #ffffff; opacity: 0.7;
                ...
                <tr>
                    <td >
                        <h2 class="clsTituloInterior">
                            REPORTES DE COMPRAS DE AGROCOMERCIO S.R.L.</h2>
                        &nbsp;<br />
                    </td>
                </tr>
                <tr>
                                        ...
                                        <table class="tableIzquierda">
                                            <tr>
                                                ...
                                                <td class="clsCellDatos2">
                                                    <asp:DropDownList ID="ddlReportes" runat="server" Width="250px" AutoPostBack="True"
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <h3>
                                                        <asp:Label ID="lblSubTitulo" runat="server" Text="Label">Reportes de Compras</asp:Label></h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                            ...
                                            <tr>
                                                <td class="clsCellTituloDatos2">
                                                    ...
                                                    <asp:CheckBox ID="chkPorMes" runat="server" Text="Por Mes:  " AutoPostBack="True"
                                                        OnCheckedChanged="chkPorMes_CheckedChanged" />
                                                </td>
                                                <td class="clsCellDatos2">
                                                    ...
                                                    <asp:DropDownList ID="ddlMeses" runat="server" Width="250px" AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
