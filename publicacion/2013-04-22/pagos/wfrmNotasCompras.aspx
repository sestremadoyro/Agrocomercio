<%@ Page Title=".:Registro de Notas:." Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmNotasCompras.aspx.cs" Inherits="AgrocomercioWEB.pagos.wfrmNotasCompras" %>
                                                        ...
                                                        <table class="tabPedidos">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:CalendarExtender ID="txtFecDesde_CalendarExtender" runat="server" 
                                                                        Enabled="True" Format="yyyy-MM-dd" PopupButtonID="Image2" 
                                                                        TargetControlID="txtFecDesde">
                                                                ...
                                                                <td colspan="4">
                                                                    <asp:GridView ID="dgvNotas" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="FecEmesion" HeaderText="Fec. Emesion" 
                                                                            ...
                                                                            <asp:BoundField DataField="cobservaciones" HeaderText="cobservaciones" SortExpression="cobservaciones" Visible=false />
                                                                        </Columns>
                                                                        <EmptyDataTemplate>
                                                                            <i>
                                                        ...
                                                        <h3>Registro De Notas</h3>
                                                         <table class="tabPedidos">
                                                          <tr>
                                                            ...
                                                            <tr>
                                                            <td align ="right">Tipo de Nota:</td>
                                                            <td>
